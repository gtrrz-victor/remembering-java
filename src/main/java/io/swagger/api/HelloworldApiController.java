...
import io.swagger.api.helloworld.HeaderNotAllowedException;
import io.swagger.api.helloworld.ResponseFactory;
...
public class HelloworldApiController implements HelloworldApi {
    ...
    public HelloworldApiController(ObjectMapper objectMapper, HttpServletRequest request) {
    ...
    public ResponseEntity<String> readHelloWorld() {
        String accept = request.getHeader("Accept");
            try {
                return ResponseFactory.valueByAccept(accept).createResponse(objectMapper).build();
            } catch (HeaderNotAllowedException e) {
